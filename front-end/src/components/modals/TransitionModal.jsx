...
const TransitionModal = ({
  ...
  const transitionState = {
    ...
    allowsChangeTitleAndDescription: false,
  ...
  const initialValues = {
    ...
    // condtional values
    allowChangePriority: transitionState.allowChangePriority || true,
    ...
    const formData = {
      updateMaintenance: {
        ...
        ...(transitionState.allowsChangeRequestTypes && {
          maintenanceRequestTypeIds: values.maintenanceRequestTypes,
        }),
        ...(transitionState.allowsForwardToPerson && {
          assignedPersonIds: values.assignedPersons.map((person) => person.id),
        }),
      ...
      updateRequestStatus: {
        ...(transitionState.hasSchedule && {
          scheduleMaintenanceStartDateTime:
            values.scheduleMaintenanceStartDateTime,
          scheduleMaintenanceEndDateTime: values.scheduleMaintenanceEndDateTime,
        }),
