...
class _RequestsPageState extends State<RequestsPage> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: requests == null
          ? const Center(child: CircularProgressIndicator()) // Show loading indicator if requests is null
          : (requests?.items == null || requests!.items.isEmpty)
              ? const Center(child: Text("No requests until now")) // Show message if items list is null or empty
              : ListView.builder(
